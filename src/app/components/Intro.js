const Intro = props => {
  return (
    <section className="bg-[#3a3a3e]">
      <div className="text-xl md:text-2xl text-[#c8a16e] uppercase p-5 text-center font-extralight tracking-widest">Композиция мебели для ванной комнаты {props.title}</div>
