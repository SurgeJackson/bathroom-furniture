                    ...
                    return (
                        <li className="w-full h-full max-w-[100%] overflow-hidden list-none" key={obj.id}>
                            <div className="h-full bg-[75%] bg-cover" key={obj.id}>
                                <div className="absolute flex justify-end items-end w-full h-full top-0 left-0 text-4xl md:text-5xl z-[3] text-right">
                                    <div className="leading-tight font-light uppercase drop-shadow-md mb-20 md:mb-10 mx-10 md:mx-20 text-white">
                                        {obj.title}
                                    </div>
                                </div>
                                <motion.div
