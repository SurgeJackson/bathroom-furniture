...
const Video = () => {
    return (
        <section className="relative h-[645px] w-full overflow-hidden bg-cover">
            <video
                ...
                autoPlay={true} />
            <div className="flex flex-col justify-center absolute top-1/2 left-1/2 translate-y-[-50%] translate-x-[-50%] w-3/4 z-[100] text-center font-extralight">
