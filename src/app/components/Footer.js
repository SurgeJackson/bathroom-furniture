      ...
      <div className="pt-[50px] text-center">
        <div className="flex justify-center items-center relative w-[190px] my-0 mx-auto space-x-10">
          <Link className="flex justify-center w-5 h-5 hover:text-white transition-colors duration-500" href="/" rel="nofollow noopener noreferrer">
            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" stroke="currentColor" stroke-width="0.5" viewBox="0 0 20 17">
          ...
          <Link className="flex justify-center w-5 h-5 hover:text-white transition-colors duration-500" href="/" rel="nofollow noopener noreferrer">
            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" stroke="currentColor" stroke-width="0.5" viewBox="0 0 18 15">
          ...
          <Link className="flex justify-center w-5 h-5 hover:text-white transition-colors duration-500" href="/" rel="nofollow noopener noreferrer">
            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" stroke="currentColor" stroke-width="0.5" viewBox="0 0 21 12">
