const CompanyFeatures = () => {
    return (
        <section className="bg-white flex flex-col px-[5%] pb-10 text-black">
            <div className="text-4xl py-[50px] font-extralight text-center md:text-left">Почему мебель для ванной комнаты STURM</div>
